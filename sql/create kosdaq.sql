CREATE TABLE public.kosdaq (
    ...
    CONSTRAINT kosdaq_pkey PRIMARY KEY (name, volume, created_at)
);

CREATE INDEX kosdaq_change_10m_idx ON public.kosdaq USING btree (change_10m);
CREATE INDEX kosdaq_change_11m_idx ON public.kosdaq USING btree (change_11m);
CREATE INDEX kosdaq_change_1d_idx ON public.kosdaq USING btree (change_1d);
CREATE INDEX kosdaq_change_1h_idx ON public.kosdaq USING btree (change_1h);
CREATE INDEX kosdaq_change_1m_idx ON public.kosdaq USING btree (change_1m);
CREATE INDEX kosdaq_change_1w_idx ON public.kosdaq USING btree (change_1w);
CREATE INDEX kosdaq_change_2d_idx ON public.kosdaq USING btree (change_2d);
CREATE INDEX kosdaq_change_2m_idx ON public.kosdaq USING btree (change_2m);
CREATE INDEX kosdaq_change_2w_idx ON public.kosdaq USING btree (change_2w);
CREATE INDEX kosdaq_change_3d_idx ON public.kosdaq USING btree (change_3d);
CREATE INDEX kosdaq_change_3m_idx ON public.kosdaq USING btree (change_3m);
CREATE INDEX kosdaq_change_3w_idx ON public.kosdaq USING btree (change_3w);
CREATE INDEX kosdaq_change_4d_idx ON public.kosdaq USING btree (change_4d);
CREATE INDEX kosdaq_change_4m_idx ON public.kosdaq USING btree (change_4m);
CREATE INDEX kosdaq_change_4w_idx ON public.kosdaq USING btree (change_4w);
CREATE INDEX kosdaq_change_5d_idx ON public.kosdaq USING btree (change_5d);
CREATE INDEX kosdaq_change_5m_idx ON public.kosdaq USING btree (change_5m);
CREATE INDEX kosdaq_change_6d_idx ON public.kosdaq USING btree (change_6d);
CREATE INDEX kosdaq_change_6m_idx ON public.kosdaq USING btree (change_6m);
CREATE INDEX kosdaq_change_7m_idx ON public.kosdaq USING btree (change_7m);
CREATE INDEX kosdaq_change_8m_idx ON public.kosdaq USING btree (change_8m);
CREATE INDEX kosdaq_change_9m_idx ON public.kosdaq USING btree (change_9m);

ALTER TABLE kosdaq ADD COLUMN change_2h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_3h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_4h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_5h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_6h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_7h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_8h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_9h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_10h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_11h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_12h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_13h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_14h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_15h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_16h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_17h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_18h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_19h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_20h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_21h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_22h numeric NULL;
ALTER TABLE kosdaq ADD COLUMN change_23h numeric NULL;